...
public class GoogleSearch {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			d0GoogleSearch(searchKey,"selenium", suggestions, "selenium tutorial");
		...
		public static void d0GoogleSearch(By searchLocator, String searchKey, By suggLocator, String value) throws InterruptedException {
